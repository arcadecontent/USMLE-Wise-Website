...
<main id="top" class="cc">
  ...
  <section style="background:var(--uw-surface);padding:clamp(48px,6vw,80px) 0;border-top:1px solid var(--uw-border);overflow:hidden">
    ...
    <div class="cc-marquee-mask" style="position:relative;-webkit-mask-image:linear-gradient(90deg,transparent,#000 4%,#000 96%,transparent);mask-image:linear-gradient(90deg,transparent,#000 4%,#000 96%,transparent)">
        <div class="cc-marquee-track"><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t06.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t14.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t03.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t04.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t05.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t15.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t27.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t28.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t31.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t32.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t60.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t82.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t83.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t16.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t76.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t52.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t89.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t11.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t12.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t38.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t95.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t17.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t20.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t90.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t96.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t06.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t14.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t03.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t04.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t05.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t15.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t27.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t28.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t31.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t32.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t60.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t82.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t83.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t16.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t76.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t52.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t89.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t11.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t12.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t38.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t95.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t17.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t20.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t90.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div><div style="flex:0 0 auto;height:340px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-sm);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t96.webp" alt="Student testimonial screenshot" style="height:340px;width:auto;display:block"></div></div>
      </div>
  </section>
      ...
      <div style="background:var(--uw-surface);border:1px solid var(--uw-border);border-radius:var(--r-xl);box-shadow:var(--shadow-lg);overflow:hidden;text-align:left">
        ...
        <div style="background:var(--uw-blue-500);color:#fff;padding:clamp(24px,4vw,36px);position:relative;overflow:hidden">
          ...
          <div style="position:relative;z-index:1;text-align:center">
            ...
            <div style="display:flex;flex-direction:column;align-items:stretch;gap:12px;max-width:340px;margin:0 auto">
              <a href="https://nas.com/checkout-global?communityId=678e896792ccbd5774869190&communityCode=USMLE_UPDATES_2&requestor=whatsappSignup&linkClicked=https%3A%2F%2Fnas.com%2Fportal%2Fdigital-files%2Fmanage%3Fid%3D692684e1c205076c86d084c4&sourceInfoType=folder&sourceInfoOrigin=692684e1c205076c86d084c4" target="_blank" rel="noopener noreferrer" style="display:block"><span class="btn btn--primary btn--xl" style="width:100%">Get Access Now</span></a>
              <a href="https://wa.me/19192015700?text=I%20am%20interested%20in%20step%201%20crash%20course%20free%20preview" target="_blank" rel="noopener noreferrer" style="display:flex;align-items:center;justify-content:center;gap:10px;background:#25D366;color:#fff;font-weight:600;font-size:16px;line-height:1;padding:18px 32px;border-radius:var(--r-md);box-shadow:var(--shadow-sm)">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" style="flex:none"><path d="M12.04 2C6.58 2 2.13 6.45 2.13 11.91c0 1.75.46 3.45 1.32 4.95L2 22l5.25-1.38c1.45.79 3.08 1.21 4.79 1.21 5.46 0 9.91-4.45 9.91-9.91C21.95 6.45 17.5 2 12.04 2zm0 18.15c-1.52 0-3.01-.41-4.31-1.18l-.31-.18-3.12.82.83-3.04-.2-.31a8.21 8.21 0 0 1-1.26-4.35c0-4.54 3.7-8.23 8.24-8.23 4.54 0 8.23 3.69 8.23 8.23 0 4.54-3.69 8.24-8.23 8.24zm4.52-6.16c-.25-.12-1.47-.72-1.69-.81-.23-.08-.39-.12-.56.12-.16.25-.64.81-.79.97-.14.17-.29.19-.54.06-.25-.12-1.05-.39-1.99-1.23-.74-.66-1.23-1.47-1.38-1.72-.14-.25-.01-.38.11-.51.11-.11.25-.29.37-.43.12-.14.16-.25.25-.41.08-.17.04-.31-.02-.43-.06-.12-.56-1.34-.76-1.84-.2-.48-.41-.42-.56-.42-.14-.01-.31-.01-.48-.01-.16 0-.43.06-.66.31-.23.25-.86.85-.86 2.07 0 1.22.89 2.4 1.01 2.56.12.17 1.75 2.67 4.23 3.74.59.26 1.05.41 1.41.52.59.19 1.13.16 1.56.1.48-.07 1.47-.6 1.67-1.18.21-.58.21-1.07.14-1.18-.06-.1-.22-.16-.47-.28z"></path></svg>
                Request Free Preview
              </a>
              <div style="font-size:12.5px;color:rgba(255,255,255,.7)">Not ready to enroll? Message us and we'll send a sample lesson.</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div style="max-width:1080px;margin:0 auto">
      ...
      <div class="cc-wall" style="max-height:660px;overflow-y:scroll;padding:20px 22px;border:1px solid var(--uw-border);border-radius:var(--r-xl);background:var(--uw-surface);box-shadow:var(--shadow-sm) inset">
        <div class="cc-wall-grid" style="columns:3;column-gap:14px">
          ...
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t27.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t28.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t30.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t31.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t32.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t60.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t82.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t83.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          ...
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t26.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t42.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t47.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t48.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t50.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t52.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t53.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t56.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t76.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t78.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t81.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t88.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t89.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t91.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          ...
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t38.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t40.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t41.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t66.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t95.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t98.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          ...
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t33.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t37.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t39.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t43.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t44.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t45.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t90.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t96.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
          <div style="break-inside:avoid;margin-bottom:14px;border:1px solid var(--uw-border);border-radius:var(--r-lg);overflow:hidden;box-shadow:var(--shadow-xs);background:var(--uw-surface)"><img src="/assets/step1-crash-course/testimonials/t99.webp" alt="Student testimonial screenshot" loading="lazy" style="width:100%;display:block"></div>
        </div>
      </div>
    </div>
  </section>
  ...
  <section style="background:var(--uw-blue-800);color:#fff;position:relative;overflow:hidden;padding:clamp(56px,7vw,88px) clamp(20px,5vw,48px)">
    ...
    <div style="position:relative;z-index:1;max-width:760px;margin:0 auto;text-align:center">
      ...
      <div style="display:flex;flex-wrap:wrap;justify-content:center;align-items:center;gap:14px;margin-top:clamp(28px,3.5vw,40px)">
        <a href="#offer"><span class="btn btn--primary btn--xl">Enroll Now</span></a>
  ...
  <section id="contact" style="background:var(--uw-surface);padding:clamp(56px,7vw,96px) clamp(20px,5vw,48px);border-top:1px solid var(--uw-border)">
    <div class="cc-contact" style="max-width:1080px;margin:0 auto;display:grid;grid-template-columns:.9fr 1.1fr;gap:clamp(32px,5vw,64px);align-items:start">
      <div>
        ...
        <a href="https://wa.me/19192015700" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:10px;background:#25D366;color:#fff;font-weight:600;font-size:15px;padding:13px 22px;border-radius:var(--r-md);box-shadow:var(--shadow-sm)">
