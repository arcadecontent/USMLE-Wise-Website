<?php
$pageTitle = "General Surgery — Baptist Health, Fort Smith AR | USMLE Wise";
$pageDescription = "4-week hands-on General Surgery rotation at Baptist Health Fort Smith, Arkansas. Colonoscopy, mastectomy, colorectal surgery, 50%+ hospital time, LOR on hospital letterhead.";
$canonical = "https://usmlewise.com/rotations/arkansas-surgery";
$bodyClass = "msp";
$stylesheets = [
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            ...
            <span class="rot-feature__top-specialty">Baptist Health — Fort Smith</span>
          </div>

          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">General Surgery at<br>Baptist Health Fort Smith</h1>
              <p class="rot-feature__hospital">Baptist Health &mdash; Fort Smith, Arkansas</p>
              <span class="rot-feature__setting-badge">Inpatient + OR Observation &nbsp;&middot;&nbsp; 4 Weeks &nbsp;&middot;&nbsp; 50%+ Hospital Time</span>
            </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Comprehensive, hands-on General Surgery rotation under the guidance of a highly skilled surgeon with expertise across a wide range of conditions.</li>
                  <li>Designed for international medical students and graduates seeking immersive clinical exposure and active participation in surgical care.</li>
                  <li>More than 50% of rotation time spent at Baptist Health — Fort Smith hospital.</li>
                  <li><strong>Max students:</strong> 2.</li>
                </ul>
              </div>
              <div class="rot-feature__section">
                <span class="rot-feature__section-label">Case exposure</span>
                <ul class="rot-feature__list">
                  <li>Colonoscopy and endoscopic procedures.</li>
                  <li>Mastectomy and breast surgery.</li>
                  <li>Surgical removal of the colon and colorectal procedures.</li>
                  <li>A range of general surgical conditions and presentations.</li>
                </ul>
              </div>
              <div class="rot-feature__section">
                <span class="rot-feature__section-label">OR experience</span>
                <ul class="rot-feature__list">
                  <li>Opportunity to observe surgeries directly in the OR.</li>
                  <li>Direct involvement in surgical care provides excellent learning, helping you understand surgical techniques and the dynamics of the OR.</li>
                </ul>
              </div>
            </div>
            <div class="rot-feature__lor-panel">
              <span class="rot-feature__section-label">Letter of recommendation</span>
              <p class="rot-feature__text">Upon successful completion of the rotation, you will receive a personalized LoR based on your performance on official hospital letterhead.</p>
              <div class="rot-feature__section">
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Colonoscopy</span>
            <span class="rot-dtag">Colorectal</span>
