<?php
$pageTitle = "Psychiatry Rotation — Medical Director, Houston Texas | USMLE Wise";
$pageDescription = "4-week psychiatry rotation with Psychiatry Medical Director in Houston, Texas. 30 years experience, all ages including children and adolescents. Max 2 students, LOR included.";
$canonical = "https://usmlewise.com/rotations/houston-psychiatry";
$bodyClass = "msp";
$stylesheets = [
    "/rotations.css"
];
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 14</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Psychiatry Medical Director<br>Houston, Texas</h1>
              <p class="rot-feature__hospital">Psychiatry Medical Director, Houston</p>
              <span class="rot-feature__setting-badge">Psychiatry Rotation &nbsp;&middot;&nbsp; All Ages &mdash; 30 Years Experience</span>
            </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Psychiatry Medical Director with 30 years of clinical experience.</li>
                  <li>Exposure to patients of <strong>all ages</strong>, including children, adolescents, and adults.</li>
                  <li>Preceptor has been part of the medical staff at the <strong>University of Houston</strong>, providing psychiatric evaluations and case management for graduate students.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Diverse caseload spanning child, adolescent, and adult psychiatric presentations.</li>
                  <li>Direct mentorship from a psychiatrist with three decades of clinical experience.</li>
                  <li>Experience with university health setting and case management principles.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">All Ages</span>
            <span class="rot-dtag">Child &amp; Adolescent</span>
            <span class="rot-dtag">30 Years Experience</span>
