<?php
$pageTitle = "Family Medicine Rotation — Englewood Hospital, New Jersey | USMLE Wise";
$pageDescription = "4-week family medicine rotation with Chief of Family Practice at Englewood Hospital, NJ. Board-certified in FM, Geriatrics & Palliative Medicine. Clinic, living facilities, nursing homes. Max 2 students.";
$canonical = "https://usmlewise.com/rotations/englewood-family-medicine";
$bodyClass = "msp";
$stylesheets = [
    "/rotations.css"
];
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 20</span>
            <span class="rot-feature__top-loc"><i data-lucide="map-pin" width="11" height="11"></i> Englewood, New Jersey</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Englewood Hospital<br>and Medical Center</h1>
              <p class="rot-feature__hospital">Chief of Family Practice — Englewood Hospital</p>
              <span class="rot-feature__setting-badge">Family Medicine &nbsp;&middot;&nbsp; Clinic, Living Facilities &amp; Nursing Homes</span>
            </div>
          ...
          <div class="rot-feature__stats-bar reveal">
            ...
            <div class="rot-feature__stat-col"><strong>Mon–Fri</strong><span>9 am – 5 pm</span></div>
          </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Chief of Family Practice at Englewood Hospital and Medical Center.</li>
                  <li>Preceptor is board-certified in <strong>Family Medicine, Geriatric Medicine, and Hospice and Palliative Medicine</strong>.</li>
                  <li>Comprehensive exposure across multiple care settings: <strong>outpatient clinic, living facilities, and nursing homes</strong>.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Full-time schedule Monday through Friday, <strong>9:00 am to 5:00 pm</strong>.</li>
                  <li>Rotations across outpatient clinic, assisted living facilities, and nursing home visits.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Palliative Care</span>
            <span class="rot-dtag">Nursing Homes</span>
