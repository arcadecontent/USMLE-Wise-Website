<?php
$pageTitle = "Psychiatry Rotation — Medical Director, Mequon Wisconsin | USMLE Wise";
$pageDescription = "4-week psychiatry rotation with Psychiatry Medical Director in Mequon, Wisconsin. Telehealth, clinic, ADHD, EMR. Former UW-Madison Assistant Professor. Max 2 students, LOR included.";
$canonical = "https://usmlewise.com/rotations/wisconsin-psychiatry";
$bodyClass = "msp";
$stylesheets = [
    "/rotations.css"
];
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 13</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Psychiatry Medical Director<br>Mequon, Wisconsin</h1>
              <p class="rot-feature__hospital">Private Clinic, Mequon, Wisconsin</p>
              <span class="rot-feature__setting-badge">Psychiatry Rotation &nbsp;&middot;&nbsp; Telehealth + Clinic</span>
            </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Psychiatry Medical Director, Mequon, Wisconsin.</li>
                  <li>Well-rounded experience covering <strong>telehealth, clinic, program and business development, patient care, EMR use</strong>, and lectures on ADHD.</li>
                  <li>Before opening his clinic, preceptor served as <strong>Assistant Professor of Psychiatry</strong> at the University of Wisconsin-Madison School of Medicine and Public Health.</li>
                  <li>Also maintained roles as a <strong>Medical Advisor for a medical program for 6 years</strong>.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Exposure to both in-person clinic visits and telehealth sessions.</li>
                  <li>Lectures on ADHD and other psychiatric conditions.</li>
                  <li>EMR training and practical clinical documentation experience.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Telehealth</span>
            <span class="rot-dtag">Psychiatry</span>
            <span class="rot-dtag">ADHD</span>
