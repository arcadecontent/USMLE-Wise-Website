<?php
$pageTitle = "Psychiatry Rotation — Flourish Mental Health, Houston TX | USMLE Wise";
$pageDescription = "4-week child and adolescent psychiatry rotation with Physician at Flourish Mental Health in Houston, Texas. Mon–Fri 9am–7pm, max 1 student, LOR on clinic letterhead.";
$canonical = "https://usmlewise.com/rotations/flourish-psychiatry";
$bodyClass = "msp";
$stylesheets = [
    "/rotations.css"
];
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 10</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Flourish Mental Health<br>Houston, Texas</h1>
              <p class="rot-feature__hospital">Physician with Flourish Mental Health</p>
              <span class="rot-feature__setting-badge">Psychiatry Rotation &nbsp;&middot;&nbsp; Child &amp; Adolescent Focus</span>
            </div>
            <div class="rot-feature__price-card">
              <div class="rot-feature__price">$2,800</div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Physician with Flourish Mental Health.</li>
                  <li>Broad experience in a variety of psychiatric cases with a child and adolescent psychiatrist.</li>
                  <li>Preceptor has a strong educational background and expertise in <strong>autism</strong>.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Full clinic schedule Monday through Friday, 9:00 am to 7:00 pm.</li>
                  <li>Exposure to child, adolescent, and autism-spectrum cases throughout the rotation.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Autism Expertise</span>
