<?php
$pageTitle = "General Surgery — Larkin Community Hospital, Miami | USMLE Wise";
$pageDescription = "4-week hands-on General Surgery rotation at Larkin Community Hospital and Hialeah Hospital in Miami, FL. Inpatient, surgical centers, OR observation, LOR on hospital letterhead.";
$canonical = "https://usmlewise.com/rotations/miami-surgery";
$bodyClass = "msp";
$stylesheets = [
    "/rotations.css"
];
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            ...
            <span class="rot-feature__top-specialty">ACGME-Accredited Site</span>
          </div>

          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">General Surgery at<br>Larkin Community Hospital</h1>
              <p class="rot-feature__hospital">Larkin Community Hospital &amp; Hialeah Hospital &mdash; Miami, Florida</p>
              <span class="rot-feature__setting-badge">Inpatient + Surgical Centers &nbsp;&middot;&nbsp; 4 Weeks &nbsp;&middot;&nbsp; OR Observation</span>
            </div>
            <div class="rot-feature__price-card">
              <div class="rot-feature__price">$3,400</div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Hands-on General Surgery rotation with a General Surgeon affiliated with Larkin Community Hospital and Hialeah Hospital.</li>
                  <li>Follow top-tier surgeons and round alongside high-calibre Caribbean students in a true inpatient surgical environment.</li>
                  <li>Exposure includes both inpatient settings and surgical centers.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Hands-on surgical experience across inpatient and outpatient surgical centers.</li>
                  <li>Opportunity to observe in the OR.</li>
                  <li>Networking opportunities at an ACGME-accredited General Surgery program — a genuine advantage for your application.</li>
                  <li>Exposure to a competitive clinical environment alongside Caribbean students enrolled in accredited programs.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Surgical Centers</span>
            <span class="rot-dtag">OR Observation</span>
            <span class="rot-dtag">ACGME Site</span>
