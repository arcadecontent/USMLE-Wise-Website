<?php
$pageTitle = "Pediatrics Rotation — Medical Director, Arlington Virginia | USMLE Wise";
$pageDescription = "4-week pediatrics rotation with Medical Director in Arlington, Virginia. Independent patient encounters, physical exams, EMR training, management plans. LOR on clinic letterhead.";
$canonical = "https://usmlewise.com/rotations/arlington-pediatrics";
$bodyClass = "msp";
$stylesheets = [
    "/rotations.css"
];
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 17</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Pediatrics Medical Director<br>Arlington, Virginia</h1>
              <p class="rot-feature__hospital">Private Clinic, Arlington, Virginia</p>
              <span class="rot-feature__setting-badge">Pediatrics Rotation &nbsp;&middot;&nbsp; Independent Patient Encounters &amp; EMR</span>
            </div>
          ...
          <div class="rot-feature__stats-bar reveal">
            ...
            <div class="rot-feature__stat-col">
              <strong>EMR</strong>
              <span>Full access &amp; training</span>
            </div>
          </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Pediatrics Medical Director, Arlington, Virginia.</li>
                  <li>Excellent hands-on experience designed to show how <strong>pediatric care is managed in the USA</strong>.</li>
                  <li>Learn to <strong>see patients independently</strong>, conduct physical examinations, and present patients to the preceptor.</li>
                  <li>Propose <strong>management plans</strong> and become proficient with the <strong>EMR system</strong>.</li>
                </ul>
              </div>
              <div class="rot-feature__section">
                <span class="rot-feature__section-label">What to expect</span>
                <ul class="rot-feature__list">
                  <li>Progressive clinical autonomy with direct preceptor feedback.</li>
                  <li>Hands-on EMR documentation from the start of the rotation.</li>
                  <li>Practical exposure to US outpatient pediatric workflows.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Independent Encounters</span>
            <span class="rot-dtag">EMR Training</span>
            <span class="rot-dtag">Physical Examinations</span>
