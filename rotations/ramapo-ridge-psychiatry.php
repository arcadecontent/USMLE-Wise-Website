<?php
$pageTitle = "Psychiatry Rotation — Ramapo Ridge Psychiatric Hospital, Wayne NJ | USMLE Wise";
$pageDescription = "4-week adult psychiatry rotation with Department Head at Ramapo Ridge Psychiatric Hospital in Wayne, New Jersey. 30 hrs/week outpatient, geriatric subspecialty, max 1 student, LOR included.";
$canonical = "https://usmlewise.com/rotations/ramapo-ridge-psychiatry";
$bodyClass = "msp";
$stylesheets = [
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 11</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Ramapo Ridge<br>Psychiatric Hospital</h1>
              <p class="rot-feature__hospital">Department Head, Ramapo Ridge Psychiatric Hospital</p>
              <span class="rot-feature__setting-badge">Psychiatry Rotation &nbsp;&middot;&nbsp; Adult &amp; Geriatric Subspecialty</span>
            </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Department Head at Ramapo Ridge Psychiatric Hospital.</li>
                  <li>Hands-on experience in the preceptor's outpatient clinic seeing a variety of psychiatric cases.</li>
                  <li>Preceptor has extensive experience in <strong>adult psychiatry</strong> with a subspecialty in <strong>geriatric psychiatry</strong> and substance use disorders.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Minimum of <strong>3 days per week</strong> in the outpatient clinic.</li>
                  <li>At least <strong>30 hours per week</strong> of direct outpatient exposure.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Adult Psychiatry</span>
            <span class="rot-dtag">Geriatric Subspecialty</span>
            <span class="rot-dtag">Substance Use</span>
