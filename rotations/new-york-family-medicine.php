<?php
$pageTitle = "Family Medicine Rotation — Mount Sinai Affiliated, New York City | USMLE Wise";
$pageDescription = "4-week family medicine rotation with Mount Sinai visiting attending physician in New York City. Two outpatient clinics, Mon–Fri 9am–5pm, board-certified, max 2 students, LOR included.";
$canonical = "https://usmlewise.com/rotations/new-york-family-medicine";
$bodyClass = "msp";
$stylesheets = [
    "/rotations.css"
];
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 23</span>
            <span class="rot-feature__top-loc"><i data-lucide="map-pin" width="11" height="11"></i> New York, New York</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Family Medicine<br>New York City</h1>
              <p class="rot-feature__hospital">Visiting Attending Physician with Mount Sinai Hospital</p>
              <span class="rot-feature__setting-badge">Family Medicine &nbsp;&middot;&nbsp; Two Outpatient Clinics, NYC</span>
            </div>
            <div class="rot-feature__price-card">
              <div class="rot-feature__price">$2,900</div>
          ...
          <div class="rot-feature__stats-bar reveal">
            ...
            <div class="rot-feature__stat-col"><strong>Mon–Fri</strong><span>9:00 am – 5:00 pm</span></div>
          </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Board-certified Family Medicine physician, Visiting Attending Physician with Mount Sinai Hospital.</li>
                  <li>Immersive rotation in the heart of New York City, split across <strong>two dynamic clinics</strong>.</li>
                  <li>Experience the <strong>full spectrum of primary care</strong> in a high-volume, diverse patient environment.</li>
                  <li>Full-time schedule Monday to Friday, <strong>9:00 am to 5:00 pm</strong>.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Rich patient interaction and hands-on learning across two clinic sites.</li>
                  <li>Exposure to the diversity of primary care presentations seen in a major US city.</li>
                </ul>
              </div>
            </div>
            <div class="rot-feature__lor-panel">
              <span class="rot-feature__section-label">Letter of recommendation</span>
              <p class="rot-feature__text">Personalized LoR from the supervising physician who holds the title of Visiting Attending Physician with Mount Sinai Hospital — a powerful endorsement for your residency application.</p>
              <div class="rot-feature__section">
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Mount Sinai Affiliated</span>
            <span class="rot-dtag">Board-Certified</span>
            <span class="rot-dtag">Two Clinics</span>
