<?php
$pageTitle = "Family Medicine Rotation — Oakbend Medical Center, Richmond TX | USMLE Wise";
$pageDescription = "4-week family medicine rotation with IMG physician at Oakbend Medical Center, Richmond Texas. Up to 20 patients/day, daily or 3 days/week, hands-on procedures, max 2 students.";
$canonical = "https://usmlewise.com/rotations/richmond-family-medicine";
$bodyClass = "msp";
$stylesheets = [
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 21</span>
            <span class="rot-feature__top-loc"><i data-lucide="map-pin" width="11" height="11"></i> Richmond, Texas</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Oakbend Medical Center<br>Richmond, Texas</h1>
              <p class="rot-feature__hospital">Family Medicine Physician — Former IMG</p>
              <span class="rot-feature__setting-badge">Family Medicine &nbsp;&middot;&nbsp; Outpatient Clinic &mdash; High Volume</span>
            </div>
            <div class="rot-feature__price-card">
              <div class="rot-feature__price">$1,675</div>
          ...
          <div class="rot-feature__stats-bar reveal">
            ...
            <div class="rot-feature__stat-col"><strong>Up to 20</strong><span>Patients per day</span></div>
          </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Family Medicine physician affiliated with Oakbend Medical Center, Richmond, TX.</li>
                  <li>Direct patient engagement seeing <strong>up to 20 patients per day</strong> during a full 9-hour schedule.</li>
                  <li>Flexible scheduling: available <strong>daily or three days per week</strong> to fit your timeline.</li>
                  <li>Involvement ranges from <strong>observation to active participation in procedures</strong> based on demonstrated skills.</li>
                  <li>Preceptor was himself an IMG and understands the unique path to US residency match.</li>
                  <li><strong>Max students:</strong> 2.</li>
                </ul>
              </div>
              <div class="rot-feature__section">
                <span class="rot-feature__section-label">Why this rotation</span>
                <ul class="rot-feature__list">
                  <li>Mentorship from a physician who navigated the IMG journey firsthand.</li>
                  <li>High patient volume ensures broad clinical exposure in a short period.</li>
                  <li>Flexible scheduling accommodates students with varying availability.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">IMG Mentor</span>
            <span class="rot-dtag">High Volume</span>
            <span class="rot-dtag">Flexible Schedule</span>
