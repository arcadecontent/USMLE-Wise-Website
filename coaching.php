          ...
          <div class="msp-pricing__rows">
            ...
            <div class="msp-tier reveal">
              <div class="msp-tier__info">
                ...
                <div class="msp-tier__price">$3,499</div>
              ...
              <ul class="msp-tier__features">
                ...
                <li class="msp-feat--no">Weekly 1:1 mentor guidance</li>
                <li class="msp-feat--no">Personalized program list</li>
                <li class="msp-feat--no">Signaling strategy</li>
                <li class="msp-feat--no">SOAP &amp; scramble support</li>
                <li class="msp-feat--no">Research cohort access</li>
                <li class="msp-feat--no">Match Guarantee</li>
              </ul>
            </div>
            ...
            <div class="msp-tier msp-tier--featured reveal">
              <div class="msp-tier__info">
                ...
                <div class="msp-tier__price">$5,999</div>
                <p class="msp-tier__sub">
              ...
              <ul class="msp-tier__features">
                ...
                <li class="msp-feat--no">3-hour profile assessment</li>
                <li class="msp-feat--no">Done-for-you signal applications</li>
                <li class="msp-feat--no">Unlimited CV revisions</li>
                <li class="msp-feat--no">3 Letters of Intent/Interest</li>
                <li class="msp-feat--no">Communication emails</li>
                <li class="msp-feat--no">Exclusive networking access</li>
              </ul>
            </div>
              ...
              <thead>
                <tr>
                  ...
                  <th scope="col">
                    ...
                    >
                    <span class="msp-compare__tier-price">$3,499</span>
                  </th>
                  <th scope="col">
                    <span class="msp-compare__tier-name">USMLE Match Pro</span>
                    <span class="msp-compare__tier-price">$5,999</span>
                  </th>
                  <th scope="col">
                    <span class="msp-compare__tier-name"
