  ...
  <section data-screen-label="Hero" class="uw-sec" style="padding:88px 24px 0;background:radial-gradient(760px 420px at 50% -10%, var(--uw-blue-50), transparent), var(--uw-surface);border-bottom:1px solid var(--uw-border)">
    ...
    <div style="margin-top:48px;overflow:hidden;position:relative;border-top:1px solid var(--uw-border);border-bottom:1px solid var(--uw-border);padding:16px 0;background:var(--uw-bg)">
      <div style="display:flex;width:max-content;animation:uw-marquee 42s linear infinite">
        <div class="uw-marquee" style="display:flex;gap:34px;padding-right:34px;font-family:var(--font-display);font-size:19px;color:var(--uw-ink-400);white-space:nowrap"><span>Harvard</span><span>Yale</span><span>Johns Hopkins</span><span>Stanford</span><span>Columbia</span><span>Mayo Clinic</span><span>Cornell</span><span>Penn</span><span>Mount Sinai</span><span>Cleveland Clinic</span><span>UCLA</span><span>Duke</span><span>Brown</span><span>Emory</span></div>
        <div class="uw-marquee" style="display:flex;gap:34px;padding-right:34px;font-family:var(--font-display);font-size:19px;color:var(--uw-ink-400);white-space:nowrap" aria-hidden="true"><span>Harvard</span><span>Yale</span><span>Johns Hopkins</span><span>Stanford</span><span>Columbia</span><span>Mayo Clinic</span><span>Cornell</span><span>Penn</span><span>Mount Sinai</span><span>Cleveland Clinic</span><span>UCLA</span><span>Duke</span><span>Brown</span><span>Emory</span></div>
      </div>
      <div style="text-align:center;font-family:var(--font-mono);font-size:10px;letter-spacing:.14em;text-transform:uppercase;color:var(--uw-ink-400);margin-top:14px">Our students have matched into top U.S. programs</div>
    </div>
  </section>
  ...
  <section id="pricing" data-screen-label="Pricing" class="uw-sec" style="scroll-margin-top:80px;padding:80px 24px;background:var(--uw-bg);border-bottom:1px solid var(--uw-border)">
    <div style="max-width:640px;margin:0 auto;text-align:center;display:flex;flex-direction:column;align-items:center">
      ...
      <div style="width:100%;margin-top:24px;background:var(--uw-surface);border:1px solid var(--uw-border);border-radius:var(--r-xl);box-shadow:var(--shadow-lg);overflow:hidden">
        ...
        <div style="font-family:var(--font-display);font-size:clamp(62px,11vw,88px);line-height:1;letter-spacing:-0.03em;color:var(--uw-ink-900);margin-top:6px">$299</div>
    ...
    <div style="max-width:760px;margin:0 auto;text-align:center;display:flex;flex-direction:column;align-items:center">
      ...
      <div style="display:flex;flex-direction:column;gap:12px;margin-top:36px;width:100%;text-align:left">
        <details style="background:var(--uw-bg);border:1px solid var(--uw-border);border-radius:var(--r-lg);padding:18px 22px">
          ...
          <p style="margin:14px 0 0;font-size:15.5px;line-height:1.65;color:var(--uw-ink-600);text-wrap:pretty">No, and that’s the whole point. We hand you the exact frameworks program directors use, teach them across the live masterclasses, and show you how to build every piece. You write your own personal statement. You build your own CV. You do the work. That’s how you learn to tell your story in a way a committee trusts, and it’s why this costs $299 instead of thousands. If you’d rather we build your application with you, that’s our done-for-you Match packages, and your $299 credits fully toward them.</p>
        </details>
        <details style="background:var(--uw-bg);border:1px solid var(--uw-border);border-radius:var(--r-lg);padding:18px 22px">
        ...
        <details style="background:var(--uw-bg);border:1px solid var(--uw-border);border-radius:var(--r-lg);padding:18px 22px">
          ...
          <p style="margin:14px 0 0;font-size:15.5px;line-height:1.65;color:var(--uw-ink-600);text-wrap:pretty">Your $299 credits 100% toward any USMLEWise service. Put it toward a done-for-you Match package, where physician advisors build your CV, personal statement, and strategy with you, or toward our personal statement editing service if that’s the piece you want handled. Whatever you pick, the full $299 comes off the price.</p>
        </details>
      </div>
    </div>
  </section>
...
(function () {
  ...
  function openVideoModal(id) {
    ...
    // referrerpolicy is required: the server sends Referrer-Policy: same-origin, which
    // strips the Referer on cross-origin requests and makes YouTube fail with error 153.
