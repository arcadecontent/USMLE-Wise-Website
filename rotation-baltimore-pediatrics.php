<?php
$pageTitle = "Pediatrics Rotation — 20+ Years Experience, Baltimore Maryland | USMLE Wise";
$pageDescription = "4-week pediatrics externship in Baltimore, Maryland. 20+ years experience attending, 10-15 patients/day, well child, sick child, pre-op consults, EMR access, max 1 student, LOR included.";
$canonical = "https://usmlewise.com/rotation-baltimore-pediatrics";
$bodyClass = "msp";
$stylesheets = [
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 19</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Pediatrics Externship<br>Baltimore, Maryland</h1>
              <p class="rot-feature__hospital">Outpatient Clinic &mdash; Attending with 20+ Years Experience</p>
              <span class="rot-feature__setting-badge">Pediatrics Externship &nbsp;&middot;&nbsp; Full Hands-On &amp; EMR Access</span>
            </div>
            <div class="rot-feature__price-card">
              <div class="rot-feature__price">$1,600</div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Attending physician with <strong>20+ years of experience</strong> at a high-volume outpatient pediatric clinic in Baltimore.</li>
                  <li>Full <strong>hands-on</strong> experience with <strong>EMR access</strong> from day one.</li>
                  <li>See <strong>10–15 patients per day</strong> including well child visits, sick child visits, and pre-operative consults.</li>
                  <li>Case discussions with <strong>differential diagnosis</strong> and detailed discussion of developmental milestones.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Monday through Friday, <strong>9:00 am – 6:00 pm</strong>.</li>
                  <li>High patient volume provides broad exposure to common and complex pediatric presentations.</li>
                </ul>
              </div>
            </div>
            <div class="rot-feature__lor-panel">
              <span class="rot-feature__section-label">Letter of recommendation</span>
              <p class="rot-feature__text">Fully personalized LoR based on your performance throughout the rotation.</p>
              <div class="rot-feature__section">
                <span class="rot-feature__section-label">Required documents</span>
                <ul class="rot-feature__list">
                  <li>Most updated CV</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">20+ Years Experience</span>
            <span class="rot-dtag">EMR Access</span>
            <span class="rot-dtag">Well Child &amp; Sick Child</span>
            <span class="rot-dtag">Pre-Op Consults</span>
