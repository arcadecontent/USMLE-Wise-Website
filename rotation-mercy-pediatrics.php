<?php
$pageTitle = "Pediatrics Rotation — Mercy Hospital Faculty, Miami Florida | USMLE Wise";
$pageDescription = "4-week hands-on pediatrics rotation with Faculty at Mercy Hospital in Miami, Florida. Clinic and inpatient rounding, EMR access, starts first Monday of month. LOR on hospital letterhead.";
$canonical = "https://usmlewise.com/rotation-mercy-pediatrics";
$bodyClass = "msp";
$stylesheets = [
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 18</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Mercy Hospital<br>Miami, Florida</h1>
              <p class="rot-feature__hospital">Faculty with Mercy Hospital</p>
              <span class="rot-feature__setting-badge">Pediatrics Rotation &nbsp;&middot;&nbsp; Clinic + Hospital Rounding</span>
            </div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Faculty affiliated with Mercy Hospital, Miami, Florida.</li>
                  <li>Round side by side with peers in both <strong>clinic and hospital settings</strong>.</li>
                  <li>Full <strong>EMR access</strong> to hone documentation skills throughout the rotation.</li>
                  <li>Documents must be submitted <strong>28 days prior</strong> to your start date.</li>
                  <li>Rotations start on the <strong>first Monday of each month</strong>.</li>
                </ul>
              </div>
              <div class="rot-feature__section">
                <span class="rot-feature__section-label">What to expect</span>
                <ul class="rot-feature__list">
                  <li>Exposure to a broad range of pediatric cases across both inpatient and outpatient settings.</li>
                  <li>Practical EMR training with real patient documentation.</li>
                  <li>Collaborative learning environment with other clinical students.</li>
                </ul>
              </div>
            </div>
            <div class="rot-feature__lor-panel">
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  ...
                  <li><em>All documents due 28 days before start date</em></li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Hospital Rounding</span>
            <span class="rot-dtag">EMR Access</span>
            <span class="rot-dtag">Starts 1st Monday</span>
