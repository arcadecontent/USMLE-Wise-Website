...
$pageDescription = "How USMLE Wise uses cookies, including Google Analytics and the Meta Pixel, and how to manage them.";
...
<main>
      <div class="msp-policy">
        ...
        <p>We keep cookie use to a minimum. Across the site, the cookies set on usmlewise.com come from Google Analytics, which we use to understand aggregate site traffic (for example, which pages are visited and how many people visit).</p>
        <ul>
