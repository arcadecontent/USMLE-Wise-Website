    ...
    <nav class="msp-nav__links" aria-label="Primary">
      ...
      <div class="msp-nav__item msp-nav__item--has-dd">
            ...
            <div class="msp-nav__dropdown">
              ...
              <a href="/rotations/browse" class="msp-nav__dd-link">
      ...
      <div class="msp-nav__item msp-nav__item--has-dd">
        ...
        <div class="msp-nav__dropdown">
          ...
          <a href="/research/original-research" class="msp-nav__dd-link">
            <span class="msp-nav__dd-name">Original Research</span>
            <span class="msp-nav__dd-meta">Live &middot; Mentored</span>
          </a>
          <a href="/research/review-paper" class="msp-nav__dd-link">
      ...
      <div class="msp-nav__item msp-nav__item--has-dd">
        ...
        <div class="msp-nav__dropdown">
          ...
          <a href="/match/lor-editing" class="msp-nav__dd-link">
          ...
          <a href="/match/personal-statement" class="msp-nav__dd-link">
            <span class="msp-nav__dd-name">Personal Statement</span>
            <span class="msp-nav__dd-meta">PS3X</span>
          </a>
          <a href="/match/interview-prep" class="msp-nav__dd-link">
