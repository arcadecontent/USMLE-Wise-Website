...
<header class="msp-nav" id="mspNav">
  <div class="msp-wrap msp-nav__inner">
    ...
    <a class="btn btn--primary msp-nav__cta" href="https://team.manikmadaan.com/guidance-call/book" target="_blank" rel="noopener noreferrer">Schedule free consultation</a>
  </div>
</header>
<x-dc>
<helmet>
...
<style>
  ...
  /* Standalone landing page: fewer footer nav columns than the site-wide
     footer this was copied from, so space-between leaves a large gap. */
  .msp-foot__top { justify-content: flex-start; gap: clamp(48px, 8vw, 120px); }
  .msp-nav__cta.btn--primary:hover, .msp-nav__cta.btn--primary:focus-visible { color: #fff; }
</style>
</helmet>
<div class="mp">
  ...
  <section style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-blue-800);color:#fff;position:relative;overflow:hidden">
    ...
    <div style="max-width:760px;margin:0 auto;text-align:center;position:relative;z-index:1">
      ...
      <div style="width:188px;height:188px;margin:0 auto 24px;border-radius:50%;overflow:hidden;box-shadow:var(--shadow-lg);border:4px solid rgba(255,255,255,.25)">
        <x-import component-from-global-scope="image-slot" from="./match-packages/image-slot.js" id="founder" shape="circle" placeholder="Drop founder photo" hint-size="188px,188px"><img src="/match-media/profile-pic-mrebpmf0.jpeg" alt="Dr. Manik Madaan" style="width: 100%; height: 100%; display: block; object-fit: cover"></x-import>
      </div>
  ...
  <!-- ============ 3X FRAMEWORK ============ -->
  <section id="framework" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-bg);border-top:1px solid var(--uw-border)">
  ...
  <!-- ============ OUTCOMES ============ -->
  <section id="outcomes" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-surface)">
  ...
  <!-- ============ TESTIMONIALS ============ -->
  <section id="reviews" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-bg);border-top:1px solid var(--uw-border)">
    <div style="max-width:760px;margin:0 auto 44px;text-align:center">
  ...
  <!-- ============ WHO WE HELP ============ -->
  <section id="who-we-help" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-surface)">
  ...
  <!-- ============ GUARANTEES ============ -->
  <section id="guarantees" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-bg);border-top:1px solid var(--uw-border)">
    <div style="max-width:760px;margin:0 auto 40px;text-align:center">
  ...
  <!-- ============ VIDEO STORIES ============ -->
  <section id="stories" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-surface)">
  ...
  <!-- ============ COMPARE ============ -->
  <section id="compare" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-surface)">
    <div style="max-width:760px;margin:0 auto 40px;text-align:center">
  ...
  <!-- ============ MEET THE TEAM ============ -->
  <section id="team" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-bg);border-top:1px solid var(--uw-border)">
    <div style="max-width:760px;margin:0 auto 44px;text-align:center">
    ...
    <div style="max-width:1080px;margin:0 auto;display:grid;grid-template-columns:repeat(auto-fit,minmax(280px,1fr));gap:22px">
      ...
      <div style="background:var(--uw-surface);border:1px solid var(--uw-border);border-radius:var(--r-lg);padding:28px">
        <div style="width:100%;height:280px;margin-bottom:22px;border-radius:var(--r-md);overflow:hidden;background:var(--uw-bg)"><x-import component-from-global-scope="image-slot" from="./image-slot.js" id="team-kothari" shape="rounded" radius="8" placeholder="Drop or click to upload Dr. Kothari's photo" hint-size="100%,100%"><img src="/assets/Photos/Team-Members/Nayan-Kothari.webp" alt="Dr. Nayan K. Kothari" style="width: 100%; height: 100%; display: block; object-fit: cover; transform: translate(0, 2.816%)"></x-import></div>
  ...
  <!-- ============ FAQ ============ -->
  <section id="faq" style="padding:clamp(56px,8vw,96px) 20px;background:var(--uw-bg);border-top:1px solid var(--uw-border)">
    ...
    <div class="msp-foot__top">
      ...
      <nav class="msp-foot__nav" aria-label="Footer navigation">
        <div class="msp-foot__nav-group">
          ...
          <a href="#stories">Video Stories</a>
        </div>
        <div class="msp-foot__nav-group">
