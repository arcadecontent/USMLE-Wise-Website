<?php
$pageTitle = "Pediatrics Rotation — Medical Director, Jersey City NJ | USMLE Wise";
$pageDescription = "4-week pediatrics rotation with board-certified Pediatrician in Jersey City, New Jersey. Busy outpatient clinic, Mon–Fri with extended Wednesdays, literature discussions, LOR included.";
$canonical = "https://usmlewise.com/rotation-jersey-city-pediatrics";
$bodyClass = "msp";
$stylesheets = [
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            <span class="rot-feature__num-badge">Rotation 16</span>
          ...
          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">Pediatrics Medical Director<br>Jersey City, New Jersey</h1>
              <p class="rot-feature__hospital">Board-Certified Pediatrician, Jersey City</p>
              <span class="rot-feature__setting-badge">Pediatrics Rotation &nbsp;&middot;&nbsp; Busy Outpatient Clinic</span>
            </div>
            <div class="rot-feature__price-card">
              <div class="rot-feature__price">$2,000</div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li><strong>Rotation with:</strong> Board-certified Pediatrician at a busy outpatient clinic in Jersey City.</li>
                  <li>Typical schedule is <strong>8:30 am to 4:30 pm Monday–Friday</strong>; Wednesdays extended to <strong>9:00 am – 7:00 pm</strong>.</li>
                  <li>After approximately one week (at the preceptor's discretion), learners may conduct <strong>histories independently</strong> and then present the case.</li>
                  <li>Regular <strong>literature discussions</strong> throughout the rotation on relevant pediatric topics.</li>
                </ul>
              </div>
              <div class="rot-feature__section">
                <span class="rot-feature__section-label">What to expect</span>
                <ul class="rot-feature__list">
                  <li>High-volume clinical exposure from day one.</li>
                  <li>Gradual progression toward independent patient workup as comfort increases.</li>
                  <li>Evidence-based learning integrated into daily clinic activities.</li>
                </ul>
              </div>
            </div>
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Literature Discussions</span>
