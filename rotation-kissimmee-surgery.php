<?php
$pageTitle = "General Surgery — Kissimmee, Florida | USMLE Wise";
$pageDescription = "4-week hands-on General Surgery rotation in Kissimmee, FL. Mon–Fri 9am–5pm. Pre/post-op evaluations, surgical procedures, wound care, OR observation, LOR on clinic letterhead.";
$canonical = "https://usmlewise.com/rotation-kissimmee-surgery";
$bodyClass = "msp";
$stylesheets = [
      ...
      <section class="rot-feature" id="rotation-detail">
        <div class="msp-wrap">
          ...
          <div class="rot-feature__top reveal">
            ...
            <span class="rot-feature__top-specialty">Mon–Fri · 9am–5pm EST</span>
          </div>

          <div class="rot-feature__header reveal">
            <div class="rot-feature__header-copy">
              <h1 class="rot-feature__heading">General Surgery<br>Kissimmee, Florida</h1>
              <p class="rot-feature__hospital">Clinic-Based, Kissimmee, Florida</p>
              <span class="rot-feature__setting-badge">Clinic + Surgical Procedures &nbsp;&middot;&nbsp; 4 Weeks &nbsp;&middot;&nbsp; OR Observation</span>
            </div>
            <div class="rot-feature__price-card">
              <div class="rot-feature__price">$3,200</div>
            ...
            <div class="rot-feature__content">
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Comprehensive, hands-on experience in the dynamic field of general surgery.</li>
                  <li>Typically Monday through Friday, 9am–5pm EST.</li>
                  <li>Students will gain essential surgical skills and expand their clinical knowledge.</li>
              ...
              <div class="rot-feature__section">
                ...
                <ul class="rot-feature__list">
                  <li>Conduct pre-operative and post-operative patient evaluations.</li>
                  <li>Assist in surgical procedures and manage wound care in a clinic setting.</li>
                  <li>Engage in case discussions, peer collaboration, and mentorship from experienced surgical faculty.</li>
                  <li>Participate in surgical rounds, suturing techniques, and wound care management to build essential procedural skills.</li>
                  <li>OR exposure — observation only.</li>
                </ul>
              </div>
            </div>
            <div class="rot-feature__lor-panel">
              <span class="rot-feature__section-label">Letter of recommendation</span>
              <p class="rot-feature__text">Upon successful completion of the rotation, you will receive a personalized LoR based on your performance on clinic letterhead.</p>
              <div class="rot-feature__section">
          ...
          <div class="rot-feature__footer reveal">
            ...
            <span class="rot-dtag">Surgical Procedures</span>
            <span class="rot-dtag">Wound Care</span>
