  ...
  <section id="contact" style="background:var(--uw-surface);padding:clamp(56px,7vw,96px) clamp(20px,5vw,48px);border-top:1px solid var(--uw-border)">
    <div class="cc-contact" style="max-width:1080px;margin:0 auto;display:grid;grid-template-columns:.9fr 1.1fr;gap:clamp(32px,5vw,64px);align-items:start">
      <div>
        ...
        <a href="https://web.whatsapp.com/send?phone=19192015700&text=Hey%2C%20I%20have%20questions%20for%20USMLEWise" target="_blank" rel="noopener noreferrer" style="display:inline-flex;align-items:center;gap:10px;background:#25D366;color:#fff;font-weight:600;font-size:15px;padding:13px 22px;border-radius:var(--r-md);box-shadow:var(--shadow-sm)">
